    ...
    return (
        <div className=" md:my-11 lg:my-24 text-2xl font-semibold space-y-7 p-4">
            ...
            <div className="lg:p-0">
                ...
                <p className="text-center text-xl font-normal">Do not have any account? Please <Link to='/signIn' className="text-blue-500 hover:underline">create account</Link> first.</p>
