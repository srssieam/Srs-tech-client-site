    ...
    return (
        <div className=" md:my-11 lg:my-24 text-2xl font-semibold space-y-7 p-4">
            ...
            <div className="lg:p-0">
                ...
                <button onClick={handleGoogleSignIn} className="btn bg-[#144940] normal-case text-xl max-w-max mx-auto hover:bg-[#28685d] text-white flex items-center gap-3">Sign in with google <span><FcGoogle className="text-2xl"></FcGoogle></span></button>
            </div>
        </div>
    );
};
