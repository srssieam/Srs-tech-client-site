...
const ProductCard = ({ singleProduct }) => {
    const { productName, brandName, productImg, productType, price, rating, description } = singleProduct;
    return (
        <div>
            <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-72 rounded-xl bg-clip-border">
